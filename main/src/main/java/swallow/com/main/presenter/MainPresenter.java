...
import swallow.com.main.adapter.HomeListAdapter;
import swallow.com.main.model.MainModel;
...
public class MainPresenter
        extends BasePresenter<IHomeContract.View, IHomeContract.Model>
    ...
    public MainPresenter(Context activity, RecyclerView recyclerView) {
    ...
    @Override
    protected IHomeContract.Model createModel() {
    ...
    private void initRecyclerView() {
        ...
        //添加头部banner
        LinearLayout mHeader = ((LinearLayout) LayoutInflater.from(mActivity).inflate(R.layout.view_banner, null));
