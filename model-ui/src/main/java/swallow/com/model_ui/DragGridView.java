...
public class DragGridView extends GridView {
    ...
    private DragSortViewListener dragSortViewListener;
    ...
    private OnItemLongClickListener onLongClickListener = new OnItemLongClickListener() {
        ...
        public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id) {
            ...
            //设置被长按item不显示
            if (null != dragSortViewListener) dragSortViewListener.hideView(position);
            return true;
        }
    };
    ...
    public void setAdapter(ListAdapter adapter) {
        ...
        try {
            this.dragSortViewListener = (DragSortViewListener) adapter;
        } catch (Exception e) {
            this.dragSortViewListener = null;
        }
    }
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ...
        //dragImageView处于被拖动时，更新dragImageView位置
            ...
            if ((currDraggedPosition != AdapterView.INVALID_POSITION) && (currDraggedPosition != preDraggedOverPositon)) {
                if (null != dragSortViewListener)
                    dragSortViewListener.swapView(preDraggedOverPositon, currDraggedPosition);
        ...
        //释放dragImageView
            ...
            if (null != dragSortViewListener) dragSortViewListener.showHideView();
            if ((int) dragImageView.getTag() == DRAG_IMG_SHOW) {
                windowManager.removeView(dragImageView);
                dragImageView.setTag(DRAG_IMG_NOT_SHOW);
            }
    ...
    public interface DragSortViewListener {
        void hideView(int position);

        void swapView(int preDraggedOverPositon, int currDraggedPosition);
