...
*/
public class BannerDataDao extends AbstractDao<BannerData, Integer> {
    ...
    @Override
    protected final Integer updateKeyAfterInsert(BannerData entity, long rowId) {
        return entity.getId();
    }
    
    @Override
    public Integer getKey(BannerData entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
